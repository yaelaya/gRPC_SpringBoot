...
public class CompteAdapter extends RecyclerView.Adapter<CompteAdapter.CompteViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CompteViewHolder holder, int position) {
        ...
        holder.tvCompteId.setText("N: " + compte.getId());
        holder.tvSolde.setText("Somme: " + compte.getSolde());
        holder.tvDateCreation.setText(" " + compte.getDateCreation());
        holder.tvType.setText("Tyoe de compte: " + compte.getType());
    }
